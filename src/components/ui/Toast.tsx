...
import { ToastContext, type ToastContextValue, type ToastMessage, type ToastTone, type PushToastInput } from "./toast-context";
import { CheckCircleIcon, CloseIcon, InfoIcon, WarningIcon } from "./icons";

/**
 * Minimal toast system (no dependency) — a global UI primitive.
 *
 ...
 * UI stays usable even when a request fails. The `useToast` hook lives in
 * `@/hooks/useToast` alongside the other global hooks.
 */
