 ...
 * `lib/validation.ts` and the API call lives in the component that triggers it,
 * which keeps this provider focused on state.
 */

interface ProductsOverlayContextValue {
...
const ProductsOverlayContext = createContext<ProductsOverlayContextValue | null>(null);
